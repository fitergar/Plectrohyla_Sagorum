...
#define ARCHIVO "../Season_Su_Region_2_Results/r2E2gs"
/***********************************************/
...
/*   fsal1 = fopen("../Season_Su_Region_2_Results/r2E2gs_x.txt","w"); */
/*   fsal2 = fopen("../Season_Su_Region_2_Results/r2E2gs_e.txt","w"); */
/*   fsal3 = fopen("../Season_Su_Region_2_Results/r2E2gs_p.txt","w"); */
...
/************************************************/
  ...
  FILE* ptr = fopen("../Season_Su_Region_2_Data/r2E2_datos.txt","r");
      if (ptr==NULL)
      {
