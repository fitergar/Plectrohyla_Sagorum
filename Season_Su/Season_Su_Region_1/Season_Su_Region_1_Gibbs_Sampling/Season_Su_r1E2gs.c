...
#define ARCHIVO "../Season_Su_Region_1_Results/r1E2gs"
/***********************************************/
...
/*   fsal1 = fopen("../Season_Su_Region_1_Results/r1E2gs_x.txt","w"); */
/*   fsal2 = fopen("../Season_Su_Region_1_Results/r1E2gs_e.txt","w"); */
/*   fsal3 = fopen("../Season_Su_Region_1_Results/r1E2gs_p.txt","w"); */
...
/************************************************/
  ...
  FILE* ptr = fopen("../Season_Su_Region_1_Data/r1E2_datos.txt","r");
      if (ptr==NULL)
      {
