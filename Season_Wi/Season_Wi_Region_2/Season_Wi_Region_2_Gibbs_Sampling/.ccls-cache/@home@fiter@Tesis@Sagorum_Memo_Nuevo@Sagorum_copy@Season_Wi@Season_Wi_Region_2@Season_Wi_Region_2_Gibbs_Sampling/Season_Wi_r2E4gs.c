...
int nSitios=7747;
//int nSitios=1956; // hasta generacion 4
int maxIter=1000000;
...
#define ARCHIVO "../Season_Wi_Region_2_Results/r2E4gs"
/***********************************************/
...
/*   fsal1 = fopen("../Season_Wi_Region_2_Results/r2E4gs_x.txt","w"); */
/*   fsal2 = fopen("../Season_Wi_Region_2_Results/r2E4gs_e.txt","w"); */
/*   fsal3 = fopen("../Season_Wi_Region_2_Results/r2E4gs_p.txt","w"); */
...
/************************************************/
  ...
  FILE* ptr = fopen("../Season_Wi_Region_2_Data/r2E4_datos.txt","r");
      if (ptr==NULL)
      {
  ...
  FILE* ve = fopen("../../../Neighborhood _Structure/r2_vecinos.txt","r");
      if (ve==NULL)
      {
