...
#define ARCHIVO "../Season_Wi_Region_4_Results/r4E4gs"
/***********************************************/
...
/*     fsal1 = fopen("../Season_Wi_Region_4_Results/r4E4gs_x.txt","w"); */
/*     fsal2 = fopen("../Season_Wi_Region_4_Results/r4E4gs_e.txt","w"); */
/*     fsal3 = fopen("../Season_Wi_Region_4_Results/r4E4gs_p.txt","w"); */
...
/************************************************/
  ...
  FILE* ptr = fopen("../Season_Wi_Region_4_Data/r4E4_datos.txt","r");
      if (ptr==NULL)
      {
