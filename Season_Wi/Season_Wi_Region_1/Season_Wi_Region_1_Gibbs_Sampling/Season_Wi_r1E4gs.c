...
int nSitios=9310;
//int nSitios=960; // hasta generacion 4
int maxIter=1000000;
...
#define ARCHIVO "../Season_Wi_Region_1_Results/r1E4gs"
/***********************************************/
...
/*   fsal1 = fopen("../Season_Wi_Region_1_Results/r1E4gs_x.txt","w"); */
/*   fsal2 = fopen("../Season_Wi_Region_1_Results/r1E4gs_e.txt","w"); */
/*   fsal3 = fopen("../Season_Wi_Region_1_Results/r1E4gs_p.txt","w"); */
...
/************************************************/
  ...
  FILE* ptr = fopen("../Season_Wi_Region_1_Data/r1E4_datos.txt","r");
      if (ptr==NULL)
      {
  ...
  FILE* ve = fopen("../../../Neighborhood _Structure/r1_vecinos.txt","r");
      if (ve==NULL)
      {
...
/************************************/
  ...
  for(i=384;i<nSitios;i++){
    sumXpG2+=Xp[i]; // desde generacion 2
  }
