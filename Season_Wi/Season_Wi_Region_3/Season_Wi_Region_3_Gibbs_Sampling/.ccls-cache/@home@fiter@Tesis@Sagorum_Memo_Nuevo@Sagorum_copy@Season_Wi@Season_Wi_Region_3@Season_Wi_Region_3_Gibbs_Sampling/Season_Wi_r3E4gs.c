...
int nSitios=8401;
//int nSitios=1428; // hasta generacion 4
int maxIter=1000000;
...
#define ARCHIVO "../Season_Wi_Region_3_Results/r3E4gs"
/***********************************************/
...
/*   fsal1 = fopen("../Season_Wi_Region_3_Results/r3E4gs_x.txt","w"); */
/*   fsal2 = fopen("../Season_Wi_Region_3_Results/r3E4gs_e.txt","w"); */
/*   fsal3 = fopen("../Season_Wi_Region_3_Results/r3E4gs_p.txt","w"); */
...
/************************************************/
  ...
  FILE* ptr = fopen("../Season_Wi_Region_3_Data/r3E4_datos.txt","r");
      if (ptr==NULL)
      {
