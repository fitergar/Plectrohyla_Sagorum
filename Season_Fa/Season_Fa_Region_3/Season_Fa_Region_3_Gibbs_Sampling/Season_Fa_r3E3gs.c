...
#define ARCHIVO "../Season_Fa_Region_3_Results/r3E3gs"
/***********************************************/
...
/*   fsal1 = fopen("../Season_Fa_Region_3_Results/r3E3gs_x.txt","w"); */
/*   fsal2 = fopen("../Season_Fa_Region_3_Results/r3E3gs_e.txt","w"); */
/*   fsal3 = fopen("../Season_Fa_Region_3_Results/r3E3gs_p.txt","w"); */
...
/************************************************/
  ...
  FILE* ptr = fopen("../Season_Fa_Region_3_Data/r3E3_datos.txt","r");
      if (ptr==NULL)
      {
