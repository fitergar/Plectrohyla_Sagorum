...
#define ARCHIVO "../Season_Fa_Region_4_Results/r4E3gs"
/***********************************************/
...
/*     fsal1 = fopen("../Season_Fa_Region_4_Results/r4E3gs_x.txt","w"); */
/*     fsal2 = fopen("../Season_Fa_Region_4_Results/r4E3gs_e.txt","w"); */
/*     fsal3 = fopen("../Season_Fa_Region_4_Results/r4E3gs_p.txt","w"); */
...
/************************************************/
  ...
  FILE* ptr = fopen("../Season_Fa_Region_4_Data/r4E3_datos.txt","r");
      if (ptr==NULL)
      {
