...
#define ARCHIVO "../Season_Sp_Region_3_Results/r3E1gs"
/***********************************************/
...
/*   fsal1 = fopen("../Season_Sp_Region_3_Results/r3E1gs_x.txt","w"); */
/*   fsal2 = fopen("../Season_Sp_Region_3_Results/r3E1gs_e.txt","w"); */
/*   fsal3 = fopen("../Season_Sp_Region_3_Results/r3E1gs_p.txt","w"); */
...
/************************************************/
  ...
  FILE* ptr = fopen("../Season_Sp_Region_3_Data/r3E1_datos.txt","r");
      if (ptr==NULL)
      {
