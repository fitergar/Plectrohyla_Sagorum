...
#define ARCHIVO "../Season_Sp_Region_2_Results/r2E1gs"
/***********************************************/
...
/*   fsal1 = fopen("../Season_Sp_Region_2_Results/r2E1gs_x.txt","w"); */
/*   fsal2 = fopen("../Season_Sp_Region_2_Results/r2E1gs_e.txt","w"); */
/*   fsal3 = fopen("../Season_Sp_Region_2_Results/r2E1gs_p.txt","w"); */
...
/************************************************/
  ...
  FILE* ptr = fopen("../Season_Sp_Region_2_Data/r2E1_datos.txt","r");
      if (ptr==NULL)
      {
