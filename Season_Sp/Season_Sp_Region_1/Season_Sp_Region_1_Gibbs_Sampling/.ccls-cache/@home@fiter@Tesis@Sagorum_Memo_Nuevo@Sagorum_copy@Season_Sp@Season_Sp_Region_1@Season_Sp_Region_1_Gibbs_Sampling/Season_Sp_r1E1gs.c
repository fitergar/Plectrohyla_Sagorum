...
#define ARCHIVO "../Season_Sp_Region_1_Results/r1E1gs"
/***********************************************/
...
/*     fsal1 = fopen("../Season_Sp_Region_1_Results/r1E1gs_x.txt","w"); */
/*     fsal2 = fopen("../Season_Sp_Region_1_Results/r1E1gs_e.txt","w"); */
/*     fsal3 = fopen("../Season_Sp_Region_1_Results/r1E1gs_p.txt","w"); */
...
/************************************************/
  ...
  FILE* ptr = fopen("../Season_Sp_Region_1_Data/r1E1_datos.txt","r");
      if (ptr==NULL)
      {
